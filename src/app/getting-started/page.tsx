...
export default function GettingStartedPage() {
  ...
  const getCurrentTabInfo = () => {
    ...
    return {
      title: currentTab?.label || "Getting Started",
      description: activeTab === "overview" 
        ? "Complete Next.js dashboard boilerplate with Shadcn UI and TypeScript"
        : "Explore pre-built UI components and design patterns"
    };
  };
  ...
  return (
    <Layout>
      <div className="space-y-8">
        ...
        {/* Dynamic Page Header with conditional actions */}
        <PageHeader
          title={tabInfo.title}
